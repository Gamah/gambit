...
public partial class ChessBoard
{
    ...
    {
        // GAMBIT VENDOR PATCH (s&box whitelist): upstream fanned this out over
        // Task.Run into a ConcurrentBag; neither is whitelisted, and a chess
        // client doesn't need parallel movegen. Sequential generation, same
        // moves — now in deterministic board order (the bag never guaranteed
        // any order).

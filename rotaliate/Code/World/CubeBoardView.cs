...
public sealed class CubeBoardView : Component
{
	...
	Rotaliate.UI.RotateGlyphPanel _rotateGlyphPanel;
	...
	protected override void OnStart()
	{
		...
		if ( !string.IsNullOrWhiteSpace( matPath ) )
		{
			...
			if ( _material == null )
				Log.Warning( $"[Rotaliate] Cube material '{matPath}' failed to load — using the model's default." );
		}
	}
	...
	void EnsureRotateGlyph()
	{
		...
		_rotateGlyphPanel = _rotateGlyph.AddComponent<Rotaliate.UI.RotateGlyphPanel>();

...
public sealed class PlayerData
{
	...
	/// each instance keeps its own identity. Keyed by <see cref="Gambit.Api.ApiClient.BaseUrl"/>.</summary>
	...
	static string CurrentKey => Gambit.Api.ApiClient.BaseUrl;
	...
	void MigrateLegacyIdentity()
	{
		...
		if ( !Identities.ContainsKey( Gambit.Api.ApiClient.ProdUrl ) )
			Identities[Gambit.Api.ApiClient.ProdUrl] = new Identity
			{
				Guid = LegacyGuid,
